...
{
    public class ClassLibraryTemplate : ProjectTemplate
    {
        public ClassLibraryTemplate(string name, string path) : base(name, path)
        {
            Name = name;
            Path = path;
        }
        ...
        public override ProjectWriter CreateTemplate()
        {
            ...
            var prop4 = new Property("OutputType", ProjectOutputType.ClassLibrary.GetDescription());
            ...
            var prop12 = new Property("DebugSymbols", "true");
            pGroup2.AddProperty(prop12);
